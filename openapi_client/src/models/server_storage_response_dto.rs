...
impl ServerStorageResponseDto {
    pub fn new(disk_available: String, disk_available_raw: i64, disk_size: String, disk_size_raw: i64, disk_usage_percentage: f64, disk_use: String, disk_use_raw: i64) -> ServerStorageResponseDto {
